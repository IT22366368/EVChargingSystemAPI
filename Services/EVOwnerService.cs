...
/*
 * EVOwnerService.cs
 * EV Owner Management Service
 * Date: September 2025
 * Description: Handles core business logic for EV owner registration, profile management,
 *              account activation/deactivation, and data retrieval operations.
 */
...
namespace SparkPoint_Server.Services
{
    ...
    /// <summary>
    /// Initializes MongoDB collections for EV Owners and Users.
    /// </summary>
    ...
    public class EVOwnerService
    {
        ...
        /// <summary>
        /// Deactivates a specific EV owner's account.
        /// </summary>
        ...
        /// <summary>
        /// Updates EV owner and user profile information.
        /// </summary>
        ...
        /// <summary>
        /// Reactivates a deactivated EV owner account based on NIC.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves the profile details of an EV owner using user ID.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves an EV owner profile using NIC.
        /// </summary>
        ...
        /// <summary>
        /// Checks if an EV owner is currently active based on their NIC.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves the EVOwner document using user ID.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves the EVOwner document using NIC.
        /// </summary>
        ...
        /// <summary>
        /// Retrieves all EV owners, optionally filtering by active status.
        /// </summary>
        /// <param name="isActive">true = only active, false = only inactive, null = all</param>
        public List<object> GetAllEVOwners(bool? isActive = null)
        {
            try
            {
                // 1. Get all users who are EV owners
                var evOwners = _evOwnersCollection.Find(FilterDefinition<EVOwner>.Empty).ToList();
                ...
                foreach (var evOwner in evOwners)
                {
                    ...
                    if (isActive.HasValue && user.IsActive != isActive.Value)
                        continue; // skip non-matching active status
        ...
        public EVOwnerOperationResult DeleteEVOwner(string nic)
        {
            try
            {
                var owner = _evOwnersCollection.Find(o => o.NIC == nic).FirstOrDefault();
                if (owner == null)
                {
                    return EVOwnerOperationResult.Failed(EVOwnerOperationStatus.EVOwnerNotFound, "EV Owner not found.");
                }

                _evOwnersCollection.DeleteOne(o => o.NIC == nic);

                return EVOwnerOperationResult.Success("EV Owner deleted successfully.");
            }
            catch (Exception ex)
            {
