...
namespace SparkPoint_Server.Helpers
{
    ...
    public class MongoDbContext
    {
        ...
        public MongoDbContext()
        {
            ...
            // Log MongoDB connection test result
            bool isConnected = TestConnection();
            System.Diagnostics.Trace.WriteLine($"MongoDB TestConnection: {isConnected}");
        }
        ...
        private static string GetConnectionString()
        {
            ...
            var envConnection = Environment.GetEnvironmentVariable("MONGODB_CONNECTION_STRING");
            var configConnection = ConfigurationManager.AppSettings["MongoDbConnection"];



            // Use Debug.WriteLine instead of Console.WriteLine
            System.Diagnostics.Debug.WriteLine($"ENV Connection: {envConnection}");
            System.Diagnostics.Debug.WriteLine($"CONFIG Connection: {configConnection}");
